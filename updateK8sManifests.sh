...
# $1 deploy ment file name ex:  vote-deployment.yaml
# $2 ACR repository name
# $3 is tag
# Final CMD look like
# sed -i "s|image:.*|image: <ACR-REGISTRY-NAME>/<REPROSITORY-NAME>:<TAG>|g" k8s-specifications/<prefix>-deployment.yaml
